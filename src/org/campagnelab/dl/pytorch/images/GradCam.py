...
# Code obtained from https://github.com/jacobgil/pytorch-grad-cam
# https://arxiv.org/pdf/1610.02391v1.pdf

# note, you must install cv2 with:
...
class ModelOutputs():
    ...
    def __call__(self, x):
        ...
        output = self.model.get_classifier()(output)
...
class GradCam:
    def __init__(self, model, target_layer_names, use_cuda,example_size=(32,32)):
        self.model = model
